...
// pantau perubahan banner dari Realtime Database
const bannerRef = ref(db, "settings/bannerBase64");
onValue(bannerRef, (snapshot) => {
  const bannerBase64 = snapshot.val();
  if (bannerBase64) {
    bannerImage.src = bannerBase64;
  } else {
    bannerImage.src = "assets/default-banner.jpg"; // fallback jika belum ada
  }
});
